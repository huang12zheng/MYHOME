...
insert into hs_sett.extable (TABLENAME, COLNAME, TYPENAME, COLVALUE)
values ('FUNDREAL', 'ENABLE_AMOUNT', 'NUMBER(19,2)', 'a.current_balance+a.correct_balance');

insert into hs_sett.extable (TABLENAME, COLNAME, TYPENAME, COLVALUE)
values ('FUNDREAL', 'ENABLE_BALANCE', 'NUMBER(19,2)', 'a.current_balance+a.unfrozen_balance-a.frozen_balance');
